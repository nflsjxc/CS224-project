...
def learn(args):
    ...
    if args.woi:
        train(args.o, data_loading_woi, args.p, args.v,model_encoder_name=args.m,is_rc=args.r_c)
    elif args.woc:
        train(args.o, data_loading_woc, args.p, args.v,model_encoder_name=args.m,is_rc=args.r_c)
    elif args.wov:
        train(args.o, data_loading_wov, args.p, args.v,model_encoder_name=args.m,is_rc=args.r_c)
    else:
        train(args.o, data_loading_comb, args.p, args.v,model_encoder_name=args.m,is_rc=args.r_c)

def predict(args):
    from type4py.predict import test
    setup_logs_file(args.o, "predict")
    if args.woi:
        test(args.o, data_loading_woi, args.l,model_encoder_name=args.m, read_cluster_result=args.r_c)
    elif args.woc:
        test(args.o, data_loading_woc, args.l,model_encoder_name=args.m, read_cluster_result=args.r_c)
    elif args.wov:
        test(args.o, data_loading_wov, args.l,model_encoder_name=args.m, read_cluster_result=args.r_c)
    elif args.c:
        test(args.o, data_loading_comb, args.l, args.rtc,model_encoder_name=args.m, read_cluster_result=args.r_c)
...
def eval(args):
    ...
    tasks = {'c': {'Parameter', 'Return', 'Variable'}, 'p': {'Parameter'},
             'r': {'Return'}, 'v': {'Variable'}}
    if args.woi:
        evaluate(args.o, data_loading_woi['name'], tasks[args.t] , args.tp, args.mrr,args.m)
    elif args.woc:
        evaluate(args.o, data_loading_woc['name'], tasks[args.t], args.tp, args.mrr,args.m)
    elif args.wov:
        evaluate(args.o, data_loading_wov['name'], tasks[args.t], args.tp, args.mrr,args.m)
    else:
        evaluate(args.o, data_loading_comb['name'], tasks[args.t], args.tp, args.mrr,args.m)
...
def main():
    ...
    learning_parser.add_argument('--m', '--model', default="LSTM" ,required=False, type=str, help="select encoder model : (LSTM,transformer,GRU)")
    ...
    learning_parser.add_argument('--r_c',default=False, action="store_true", help="is read model parameter directly directly")
    ...
    predict_parser.add_argument('--m', '--model', default="LSTM" ,required=False, type=str, help="select encoder model : (LSTM,transformer,GRU)")
    predict_parser.add_argument('--r_c', default=False, action="store_true", help="is read cluster rusult directly")
    ...
    eval_parser.add_argument('--m', '--model', default="LSTM" ,required=False, type=str, help="select encoder model : (LSTM,transformer,GRU)")
